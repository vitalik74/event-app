...
============================
Времени затратил около 24 часов. Буду рад услышать замечания, ошибки. Писать на tsibikov_vit@mail.ru. Тестировал на php 5.5, mysql 5.6.
...
5) adminTest 123456 логин/пароль в админку под админом.
